 ...
 * by parsing the HTTP_USER_AGENT string sent to the server [<i>utils.browser.BrowserDetection</i>].
 *
 * Typical Usage:
 * <code>
 * require_once($_SERVER['DOCUMENT_ROOT'].'/include/browser.php');
 * $br = new BrowserDetection();
 * echo "$br->Platform, $br->Name version $br->Version";
 * </code>
 *
 * Usage within SmartMVC framework:
 * <code>
 * $bd = $this->getClassOf("utils.browser.BrowserDetection");
 * $out = "$bd->Platform, $bd->Name version $bd->Version";
 * </code>
 *
 * For operating systems, it will correctly identify:<br>
 ...
 *
 * For browsers, it should correctly identify all versions of:<br>
 *  Amaya<br>
 *  Galeon<br>
 *  iCab<br>
 *  Internet Explorer<br>
 *   For AOL versions it will identify as Internet Explorer (AOL) and the version
 *   will be the AOL version instead of the IE version.<br>
 *  Konqueror<br>
 *  Lynx<br>
 *  Mozilla<br>
 *  Netscape Navigator/Communicator<br>
 *  OmniWeb<br>
 *  Opera<br>
 *  Pocket Internet Explorer for handhelds<br>
 *  Safari<br>
 *  WebTV
 *
 ...
 * GNU General Public License for more details at:<br>
