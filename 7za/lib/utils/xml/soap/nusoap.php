...
*
* @version  $Id: nusoap.php,v 1.1 2004/06/04 07:54:54 alex Exp $
* @author   Dietrich Ayala <dietrich@ganx4.com> http://dietrich.ganx4.com/nusoap
* @author   NuSphere Corporation http://www.nusphere.com
*/

/**
* Base class for all NuSOAP classes.
*
...
*
* You may read an article on O'Reilly site about using NuSOAP package
* as the SOAP server: http://webservices.xml.com/pub/a/ws/2004/03/24/phpws.html
*
* Example of usage within SmartMVC framework:
* <code>
* require_once( LIB . "utils/xml/soap/nusoap.php");
* $ns="http://localhost/nusoap";
*
* // Next step, we instantiate the SOAP server and define the settings 
* // for our WSDL file such as the service name and the namespace
* $server = new soap_server();
* $server->configureWSDL('CanadaTaxCalculator', $ns);
* $server->wsdl->schemaTargetNamespace = $ns;
*
* // Then we register our PHP tax calculation function. This step will 
* // make the server "aware" of the existence of the CalculateOntarioTax 
* // method and the values that will pass to and from the method. If you 
* // have several methods, you must register each one separately.
...
* will dynamically produce WSDL code.
*
* @author   Dietrich Ayala <dietrich@ganx4.com>
* @version  $Id: nusoap.php,v 1.1 2004/06/04 07:54:54 alex Exp $
* @package  NuSOAP
			...
			foreach($this->bindings as $bindingName => $attrs) {
				...
				foreach($attrs['operations'] as $opName => $opParts) {
					...
					if(isset($opParts['documentation']) && $opParts['documentation'] != '') {
						$portType_xml .= '<documentation>' . htmlspecialchars($opParts['documentation'], ENT_QUOTES, 'cp1251') . '</documentation>';
					}
...
//				}
	...
	*/
	function start_element($parser, $name, $attrs) {
		...
		// set name
		$this->message[$pos]['name'] = htmlspecialchars($name, ENT_QUOTES, 'cp1251');
		// set attrs
...
*
* Usage example within SmartMVC framework (the server implemetation
* example see in {@link soap_server} class):
* <code>
* require_once( LIB . 'utils/xml/soap/nusoap.php' );
* $wsdl = "http://localhost/server.php?wsdl";
* $client = new soapclient($wsdl, 'wsdl');
*
* // Next step, we create a set of parameters to pass into the 
* // Web service and then remotely call the CalculateOntarioTax method. 
* // The example shows us sending an amount of $15.00 into the web 
* // service to find out how much tax we would have to pay in Ontario
*
* $param=array(
*  'amount' => '15.00'
* ); 
