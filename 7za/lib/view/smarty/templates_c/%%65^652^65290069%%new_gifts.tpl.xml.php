<?php /* Smarty version 2.6.5-dev, created on 2017-05-23 08:11:48
         compiled from rss/new_gifts.tpl.xml */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_tags', 'rss/new_gifts.tpl.xml', 22, false),array('modifier', 'trim', 'rss/new_gifts.tpl.xml', 22, false),array('modifier', 'truncate', 'rss/new_gifts.tpl.xml', 22, false),)), $this); ?>
<?php echo '<?xml'; ?>
...
<channel>
	<title>Новинки магазина подарков TND.KIEV.UA</title>
	<link>http://www.tnd.kiev.ua/new/</link>
	<description>Новые подарки в магазине оригинальных подарков и сувениров TND.KIEV.UA</description>
